...
export default function CategoryItem({ categoryId, isEdit }: { categoryId: number; isEdit: boolean }) {
...
function UpdateCategory({ category }: { category: Category }) {
  ...
  async function updateCategory() {
    const data = Category.getByData({ ...category, content });
    ...
    <>
      ...
      <Dialog open={open} onClose={handleClose}>
        ...
        <DialogActions>
          ...
          <Button onClick={updateCategory} disabled={canUpdateCategory}>
            수정
          </Button>
        </DialogActions>
      </Dialog>

...
import {axiosGetLedgerAllDay, axiosGetLedgerDetail, ChangeSelectButton} from "../app/slices/ledgerSilce";
            ...
            <div className={"warp"}>
                ...
                {Object.entries(ledgerList).map(([date, ledgerData], index) => (
                    <div className="card shadow-lg" key={index}>
                        <Ledger date={date} isOpen={isOpen} ledgerData={ledgerData} ledgerDetail={ledgerDetail} selectButton={selectButton}/>
                    </div>
                ))}
